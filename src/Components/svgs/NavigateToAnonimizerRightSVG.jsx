    ...
    return (
        <div className={"grid-block shrink "+classes.root} onClick={props.onclickcomponent}>
            ...
            <g filter="url(#filter0_d)">
                <path d="M23.5001 42.9478C23.5289 29.9692 34.0735 19.4712 47.0522 19.5001C60.0309 19.5289 70.5288 30.0735 70.5 43.0522C70.4712 56.0308 59.9265 66.5288 46.9478 66.4999C33.9692 66.4711 23.4713 55.9265 23.5001 42.9478Z" stroke="#F86D70" stroke-width="3" className="svgitem1"/>
            </g>
            <defs>
